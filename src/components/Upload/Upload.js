      ...
      <div className="upload__margin">
        ...
        <form className="upload__flex">
          ...
          <div className="upload__flex-two">
            ...
            <input className="upload__form-title body-copy" name="title" id="title" placeholder="Add a title to your video" />
            <label className="upload__description section-subheader" htmlFor='description'>ADD A VIDEO DESCRIPTION</label>
            <textarea className="upload__form-description body-copy" name="description" id="description" placeholder="Add a description of your video"/>
          </div>
        </form>
